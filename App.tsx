...
// Using a relative path (empty string) ensures that API calls are made to the same origin
// that serves the frontend, which is correct for this setup where Node serves both.
const API_BASE_URL = '';
